...
INSERT INTO BUG (ID, ASSIGNED_ID, AUTHOR_ID, DESCRIPTION, FIXEDIN, LOCKVERSION, SEVERITY, STATUS, TARGETDATE, TITLE, VERSION) VALUES (7, 1, 1, 'sdfasdfsa', '1.3', 1, 'Medium', 'Open', '2017.09.27', 'Buggy', '1.2.3');
INSERT INTO BUG (ID, ASSIGNED_ID, AUTHOR_ID, DESCRIPTION, FIXEDIN, LOCKVERSION, SEVERITY, STATUS, TARGETDATE, TITLE, VERSION) VALUES (9, 2, 1, 'leiras', '6.5', 1, 'High', 'Closed', '2017.08.02', 'aBuggy', '4.3');
INSERT INTO BUG (ID, ASSIGNED_ID, AUTHOR_ID, DESCRIPTION, FIXEDIN, LOCKVERSION, SEVERITY, STATUS, TARGETDATE, TITLE, VERSION) VALUES (1, 1, 1, 'asdfasdfsa', '3.3', 1, 'Info needed', 'Rejected', '2017.09.26', 'nemBug', '1');
