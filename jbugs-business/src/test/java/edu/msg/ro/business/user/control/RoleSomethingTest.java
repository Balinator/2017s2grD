...
public class RoleSomethingTest extends AbstractIntegrationTest {
	...
	public void createRole_works() throws BusinessException {
		...
		test.setNameEng("sadasd");
		test.setNameRo("qwe");

		RoleDTO created = sut.createRole(test);
		Assert.assertEquals("The names did not match!", created.getNameEng(), test.getNameEng());
	}
	...
	//
	// Assert.assertEquals("After update should match!", "asd3",
	// find.getNameEN());
	// }
	//
	// @Test
